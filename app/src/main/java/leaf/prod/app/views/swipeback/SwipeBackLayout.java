package leaf.prod.app.views.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    public static final int EDGE_LEFT = SwipeBackViewDragHelper.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = SwipeBackViewDragHelper.EDGE_RIGHT;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    public static final int EDGE_BOTTOM = SwipeBackViewDragHelper.EDGE_BOTTOM;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = SwipeBackViewDragHelper.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = SwipeBackViewDragHelper.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = SwipeBackViewDragHelper.STATE_SETTLING;
    ...
    private SwipeBackViewDragHelper mDragHelper;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = SwipeBackViewDragHelper.create(this, new ViewDragCallback());
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        if (mPager != null && inRangeOfView(mPager, event)) {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mContentView != null)
            mContentView.layout(mContentLeft, mContentTop, mContentLeft + mContentView.getMeasuredWidth(), mContentTop + mContentView
                    .getMeasuredHeight());
        mInLayout = false;
    }
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent && mDragHelper.getViewDragState() != SwipeBackViewDragHelper.STATE_IDLE) {
    ...
    private class ViewDragCallback extends SwipeBackViewDragHelper.Callback {
