package com.tomcat360.lyqb.views.wheelPicker.widget;
...
public class WheelView extends ScrollView {
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFFFA4A6F;

    public static final int TEXT_COLOR_NORMAL = 0XFFFFFFFF;

    public static final int LINE_COLOR = 0XFFFFFFFF;
