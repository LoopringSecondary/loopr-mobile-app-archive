...
class UpwalletSlider extends StatefulWidget {
...
class _UpwalletSliderState extends State<UpwalletSlider> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return _UpwalletSliderRenderObjectWidget(
...
class _UpwalletSliderRenderObjectWidget extends LeafRenderObjectWidget {
  const _UpwalletSliderRenderObjectWidget({
    Key key,
    this.value,
    this.divisions,
    this.activeColor,
  ...
  @override
  _RenderUpwalletSlider createRenderObject(BuildContext context) {
    return _RenderUpwalletSlider(
      value: value,
      divisions: divisions,
  ...
  @override
  void updateRenderObject(BuildContext context, _RenderUpwalletSlider renderObject) {
    renderObject
      ..value = value
      ..divisions = divisions
      ..activeColor = activeColor
...
class _RenderUpwalletSlider extends RenderConstrainedBox {
  _RenderUpwalletSlider({
