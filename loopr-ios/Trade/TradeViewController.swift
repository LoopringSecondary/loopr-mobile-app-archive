...
class TradeViewController: UIViewController, UITextFieldDelegate, UIScrollViewDelegate, NumericKeyboardDelegate, NumericKeyboardProtocol, StepSliderDelegate {
    ...
    override func viewDidLoad() {
        ...
        P2POrderDataManager.instance.sellCount = 1
    ...
    @objc func pressedHeaderButton() {
        ...
        P2POrderDataManager.instance.swapTokenSAndTokenB()
    ...
    @objc func pressedRatioButton() {
        ...
        // vc.sellRatio = P2POrderDataManager.instance.sellRatio
        vc.dismissClosure = {
            parentView.alpha = 1
            P2POrderDataManager.instance.sellCount = vc.sellCount
    ...
    func constructMaker() -> RawOrder? {
        ...
        amountB = BigInt.generate(from: amountBuy, by: P2POrderDataManager.instance.quoteToken.decimals)
        amountS = BigInt.generate(from: amountSell, by: P2POrderDataManager.instance.baseToken.decimals)
    ...
    func pushController() {
        if let order = constructMaker() {
            ...
            P2POrderDataManager.instance.isTaker = false
