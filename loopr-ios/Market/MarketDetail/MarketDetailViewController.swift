...
class MarketDetailViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, MarketDetailDepthTableViewCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        */
        ...
        MarketDataManager.shared.getAllTrends(market: market.ticker.baseSymbol) { (_) in
            self.trends = MarketDataManager.shared.getTrends(trendRange: MarketRange.oneMonth)
        }
    }
    ...
    func setupMarket() {
        MarketOrderDataManager.instance.new(baseToken: market.ticker.quoteSymbol, quoteToken: market.ticker.baseSymbol, market: market)
