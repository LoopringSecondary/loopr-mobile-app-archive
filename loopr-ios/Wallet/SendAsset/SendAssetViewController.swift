...
class SendAssetViewController: UIViewController, UITextFieldDelegate, UIScrollViewDelegate, DefaultNumericKeyboardDelegate, NumericKeyboardProtocol, QRCodeScanProtocol, StepSliderDelegate {
    ...
    override func viewDidLoad() {
        ...
        scrollView.touchesShouldCancel(in: contactListView)
        ...
        contactListView.cornerRadius = 4
        contactListView.clipsToBounds = true
    ...
    func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        ...
        // TODO: still no solve the tap issue.
        if touch.view != nil && touch.view!.isKind(of: UITableView.self) {
            return false
        }
        return true
    }
