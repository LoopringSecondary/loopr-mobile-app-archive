...
open class ImageScrollView: UIScrollView {
    ...
    @objc open func display(image: UIImage) {
        ...
        let singlTapGesture = UITapGestureRecognizer(target: self, action: #selector(ImageScrollView.singleTapGestureRecognizer(_:)))
        singlTapGesture.numberOfTapsRequired = 1
        zoomView!.addGestureRecognizer(singlTapGesture)
        addGestureRecognizer(singlTapGesture)
        ...
        singlTapGesture.require(toFail: doubleTapGesture)
